(function(){"use strict";function c(e,t,n,s,i,o,d,l){var r=typeof e=="function"?e.options:e;return t&&(r.render=t,r.staticRenderFns=n,r._compiled=!0),o&&(r._scopeId="data-v-"+o),{exports:e,options:r}}const u={};var h=function(){var t=this,n=t._self._c;return n("div",{staticClass:"pwPreview",on:{dblclick:t.open}},[t.content.name?n("div",{staticClass:"heading"},[t._v(" "+t._s(t.content.name)+" ")]):n("div",{staticClass:"heading placeholder"},[t._v(" "+t._s(t.$t("pw.footer.name"))+" ... ")]),t._l(t.content.blocks,function(s){return n("div",{key:s.id,staticClass:"items"},[n("div",{staticClass:"linktext",class:{placeholder:!s.content.linktext}},[n("span",[t._v(t._s(s.content.linktext||t.$t("pw.field.link-text.placeholder")))]),s.content.linktarget?n("span",{staticClass:"k-icon"},[n("k-icon",{attrs:{type:"open"}})],1):t._e()])])})],2)},w=[],f=c(u,h,w,!1,null,"c4342998");const v=f.exports,g={};var k=function(){var t=this,n=t._self._c;return n("div",{staticClass:"pwPreview",on:{dblclick:t.open}},[t.content.linktext?n("div",{staticClass:"linktext"},[n("span",[t._v(t._s(t.content.linktext))]),t.content.linktarget?n("span",{staticClass:"k-icon"},[n("k-icon",{attrs:{type:"open"}})],1):t._e()]):n("div",{staticClass:"placeholder"},[t._v(" "+t._s(t.$t("pw.field.link-text.placeholder"))+" ")])])},b=[],m=c(g,k,b,!1,null,"4929f93f");const x=m.exports,H={data(){return{sharedItems:[]}},computed:{label(){const e=this.sharedItems.find(t=>t.value===this.content.sharedid);return(e==null?void 0:e.label)||this.content.sharedid||""},icon(){const e=this.sharedItems.find(t=>t.value===this.content.sharedid);return(e==null?void 0:e.icon)||null},blockName(){const e=this.sharedItems.find(t=>t.value===this.content.sharedid);return(e==null?void 0:e.name)||""}},async created(){try{const e=await this.$api.get("pagewizard/shared");this.sharedItems=Array.isArray(e)?e:[]}catch{this.sharedItems=[]}}};var V=function(){var t=this,n=t._self._c;return n("div",{staticClass:"pwPreview",attrs:{"data-kirbyblock":"shared"},on:{dblclick:t.open}},[n("div",{staticClass:"shared"},[n("div",{staticClass:"name"},[t.icon?n("k-icon",{attrs:{type:t.icon}}):t._e(),n("span",{staticClass:"blockname"},[t._v(t._s(t.blockName))])],1),n("span",[t._v("|")]),n("em",{staticClass:"sharedname"},[t._v(t._s(t.label))])])])},L=[],y=c(H,V,L,!1,null,"7d2e055d");const _=y.exports,C={props:{content:{type:Object,default:()=>({})},alignDefault:{type:String,default:"left"}},computed:{align(){return this.content.buttonalignment||this.alignDefault},isExternal(){return this.content.linktype==!0&&this.content.linktarget==!0},icon(){const e=this.content.iconposition;return e==="right"?this.content.iconright||"":e==="left"&&this.content.iconleft||""}}};var M=function(){var s;var t=this,n=t._self._c;return n("div",{staticClass:"pwButton",attrs:{"data-align":t.align}},[n("button",{staticClass:"k-button",attrs:{"data-has-text":"true","data-responsive":"true","data-size":"sm","data-variant":"filled",type:"button"}},[t.icon&&t.content.iconposition==="left"?n("span",{staticClass:"pw-link-icon",domProps:{innerHTML:t._s(t.icon)}}):t._e(),(s=t.content.linktext)!=null&&s.length?n("span",{staticClass:"k-button-text",domProps:{innerHTML:t._s(t.content.linktext)}}):n("span",{staticClass:"k-button-text placeholder"},[t._v(" "+t._s(t.$t("pw.field.link-text.placeholder"))+" ")]),t.icon&&t.content.iconposition==="right"?n("span",{staticClass:"pw-link-icon",domProps:{innerHTML:t._s(t.icon)}}):t._e(),t.isExternal?n("svg",{staticClass:"pw-external-icon",attrs:{"aria-hidden":"true",viewBox:"0 0 24 24",fill:"currentColor"}},[n("path",{attrs:{d:"M10 6V8H5V19H16V14H18V20C18 20.5523 17.5523 21 17 21H4C3.44772 21 3 20.5523 3 20V7C3 6.44772 3.44772 6 4 6H10ZM21 3V11H19L18.9999 6.413L11.2071 14.2071L9.79289 12.7929L17.5849 5H13V3H21Z"}})]):t._e()])])},D=[],z=c(C,M,D,!1,null,"9d7339bf");const $=z.exports,S={props:{value:String,align:{type:String,default:"left"}},methods:{iconOf(e){const t=e.content.iconposition;return t==="right"?e.content.iconright||"":t==="left"&&e.content.iconleft||""}}};var Z=function(){var t=this,n=t._self._c;return t.value&&t.value.length?n("div",{staticClass:"k-button-group",attrs:{"data-align":t.align}},t._l(t.value,function(s){return n("div",{key:s.id,class:{ishidden:s.isHidden}},[n("button",{staticClass:"k-button",attrs:{type:"button","data-has-text":"true","data-responsive":"true","data-size":"md","data-variant":"filled"}},[t.iconOf(s)&&s.content.iconposition==="left"?n("span",{staticClass:"pw-link-icon",domProps:{innerHTML:t._s(t.iconOf(s))}}):t._e(),s.content.linktext.length?n("span",{staticClass:"k-button-text"},[t._v(" "+t._s(s.content.linktext)+" ")]):n("span",{staticClass:"k-button-text placeholder"},[t._v(" "+t._s(t.$t("pw.field.link-text.placeholder"))+" ")]),t.iconOf(s)&&s.content.iconposition==="right"?n("span",{staticClass:"pw-link-icon",domProps:{innerHTML:t._s(t.iconOf(s))}}):t._e(),s.content.linktype==!0&&s.content.linktarget==!0?n("svg",{staticClass:"pw-external-icon",attrs:{"aria-hidden":"true",viewBox:"0 0 24 24",fill:"currentColor"}},[n("path",{attrs:{d:"M10 6V8H5V19H16V14H18V20C18 20.5523 17.5523 21 17 21H4C3.44772 21 3 20.5523 3 20V7C3 6.44772 3.44772 6 4 6H10ZM21 3V11H19L18.9999 6.413L11.2071 14.2071L9.79289 12.7929L17.5849 5H13V3H21Z"}})]):t._e()])])}),0):t._e()},A=[],E=c(S,Z,A,!1,null,"4ef01302");const O=E.exports,T={props:{label:String,help:String},computed:{translatedLabel(){return this.$t(this.label,this.label)},dataTheme(){return this.$attrs["data-theme"]||null}},template:`
	...
	`},I={extends:"k-text-field",props:{label:String,help:String,placeholder:String,value:String,align:String,level:String,size:String,textbackground:String,multiline:String,flourish:String,alignOptions:{default:null},levelOptions:{default:null},sizeOptions:{type:Array,default:null},textbackgroundOptions:{type:Array,default:null},multilineOptions:{type:Array,default:null},flourishOptions:{type:Array,default:null}},data(){return{currentAlign:this.parseValue().align||this.align||"left",currentLevel:this.parseValue().level||this.level||"h2",currentSize:this.parseValue().size||this.size||"2xl",currentTextbackground:this.parseValue().textbackground||this.textbackground||null,currentMultiline:this.parseValue().multiline||this.multiline||null,currentFlourish:this.parseValue().flourish||this.flourish||null,showAlignDropdown:!1,showLevelDropdown:!1,showSizeDropdown:!1,showTextbackgroundDropdown:!1,showMultilineDropdown:!1,showFlourishDropdown:!1}},watch:{value(e){const t=this.parseValue();t.align&&(this.currentAlign=t.align),t.level&&(this.currentLevel=t.level),t.size&&(this.currentSize=t.size),t.textbackground&&(this.currentTextbackground=t.textbackground),t.multiline&&(this.currentMultiline=t.multiline),t.flourish&&(this.currentFlourish=t.flourish)}},methods:{parseValue(){if(!this.value)return{};try{return typeof this.value=="string"?JSON.parse(this.value):this.value}catch{return{text:this.value}}},emitValue(e,t,n,s,i,o,d){const l={text:e,align:t,level:n,size:s};i&&(l.textbackground=i),o&&(l.multiline=o),d&&(l.flourish=d),this.$emit("input",JSON.stringify(l))},updateAlign(e){this.currentAlign=e,this.showAlignDropdown=!1;const t=this.parseValue();this.emitValue(t.text||"",e,t.level||this.currentLevel,t.size||this.currentSize,this.currentTextbackground,this.currentMultiline,this.currentFlourish)},updateLevel(e){this.currentLevel=e,this.showLevelDropdown=!1;const t=this.parseValue();this.emitValue(t.text||"",t.align||this.currentAlign,e,t.size||this.currentSize,this.currentTextbackground,this.currentMultiline,this.currentFlourish)},updateSize(e){this.currentSize=e,this.showSizeDropdown=!1;const t=this.parseValue();this.emitValue(t.text||"",t.align||this.currentAlign,t.level||this.currentLevel,e,this.currentTextbackground,this.currentMultiline,this.currentFlourish)},updateTextbackground(e){this.currentTextbackground=e,this.showTextbackgroundDropdown=!1;const t=this.parseValue();this.emitValue(t.text||"",t.align||this.currentAlign,t.level||this.currentLevel,t.size||this.currentSize,e,this.currentMultiline,this.currentFlourish)},updateMultiline(e){this.currentMultiline=e,this.showMultilineDropdown=!1;const t=this.parseValue();this.emitValue(t.text||"",t.align||this.currentAlign,t.level||this.currentLevel,t.size||this.currentSize,this.currentTextbackground,e,this.currentFlourish)},updateFlourish(e){this.currentFlourish=e,this.showFlourishDropdown=!1;const t=this.parseValue();this.emitValue(t.text||"",t.align||this.currentAlign,t.level||this.currentLevel,t.size||this.currentSize,this.currentTextbackground,this.currentMultiline,e)},handleInput(e){this.emitValue(e.target.value,this.currentAlign,this.currentLevel,this.currentSize,this.currentTextbackground,this.currentMultiline,this.currentFlourish)},closeDropdowns(){this.showAlignDropdown=!1,this.showLevelDropdown=!1,this.showSizeDropdown=!1,this.showTextbackgroundDropdown=!1,this.showMultilineDropdown=!1,this.showFlourishDropdown=!1},levelIcon(e){return e==="div"?"pw-level-div":e},toggleLevelDropdown(){const e=this.showLevelDropdown;this.closeDropdowns(),this.showLevelDropdown=!e},toggleAlignDropdown(){const e=this.showAlignDropdown;this.closeDropdowns(),this.showAlignDropdown=!e},toggleSizeDropdown(){const e=this.showSizeDropdown;this.closeDropdowns(),this.showSizeDropdown=!e},toggleTextbackgroundDropdown(){const e=this.showTextbackgroundDropdown;this.closeDropdowns(),this.showTextbackgroundDropdown=!e},toggleMultilineDropdown(){const e=this.showMultilineDropdown;this.closeDropdowns(),this.showMultilineDropdown=!e},toggleFlourishDropdown(){const e=this.showFlourishDropdown;this.closeDropdowns(),this.showFlourishDropdown=!e},handleClickOutside(e){this.$el.contains(e.target)||this.closeDropdowns()},textbackgroundIcon(e){const t={disabled:'<path d="M9 4.9967V11.2694H7V4.9967H5V13.9967H19V4.9967H9ZM20 15.9967H4V17.9967H20V15.9967ZM3 13.9967V3.9967C3 3.44442 3.44772 2.9967 4 2.9967H20C20.5523 2.9967 21 3.44442 21 3.9967V13.9967H22V18.9967C22 19.549 21.5523 19.9967 21 19.9967H13V22.9967H11V19.9967H3C2.44772 19.9967 2 19.549 2 18.9967V13.9967H3Z"/>',enabled:'<path d="M20 15.9967H4V17.9967H20V15.9967ZM3 13.9967V3.9967C3 3.44442 3.44772 2.9967 4 2.9967H7V11.2694H9V2.9967H20C20.5523 2.9967 21 3.44442 21 3.9967V13.9967H22V18.9967C22 19.549 21.5523 19.9967 21 19.9967H13V22.9967H11V19.9967H3C2.44772 19.9967 2 19.549 2 18.9967V13.9967H3Z"/>'};return t[e]||t.disabled},multilineIcon(e){const t={disabled:'<path d="M5 19H19V5H5V19ZM3 4C3 3.44772 3.44772 3 4 3H20C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4ZM10 8V11H14V8L18 12L14 16V13H10V16L6 12L10 8Z"/>',enabled:'<path d="M5 19H19V5H5V19ZM3 4C3 3.44772 3.44772 3 4 3H20C20.5523 3 21 3.44772 21 4V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4ZM8 10L12 6L16 10H13V14H16L12 18L8 14H11V10L8 10Z"/>'};return t[e]||t.disabled},flourishIcon(e){const t={disabled:'<path d="M5.55397 22H3.3999L10.9999 3H12.9999L20.5999 22H18.4458L16.0458 16H7.95397L5.55397 22ZM8.75397 14H15.2458L11.9999 5.88517L8.75397 14Z"/>',enabled:'<path d="M15.2459 14H8.75407L7.15407 18H5L11 3H13L19 18H16.8459L15.2459 14ZM14.4459 12L12 5.88516L9.55407 12H14.4459ZM3 20H21V22H3V20Z"/>'};return t[e]||t.disabled},handleEscape(e){e.key==="Escape"&&(this.showAlignDropdown||this.showLevelDropdown||this.showSizeDropdown||this.showTextbackgroundDropdown||this.showMultilineDropdown||this.showFlourishDropdown)&&(e.stopPropagation(),e.preventDefault(),this.closeDropdowns())},sizeLabel(e){return this.$t("pw.option."+e,e)}},mounted(){this.$nextTick(()=>{document.addEventListener("click",this.handleClickOutside,!0),document.addEventListener("keydown",this.handleEscape)})},beforeDestroy(){document.removeEventListener("click",this.handleClickOutside,!0),document.removeEventListener("keydown",this.handleEscape)},template:`
	...
	`},B={props:{value:String,align:{type:String,default:"left"},alignOptions:{type:Array,default:()=>["left","center","right"]},alwaysVisible:{type:Boolean,default:!1}},data(){return{current:this.value||this.align,show:!1,btnEl:null,dropdownEl:null,container:null,_closeHandler:null,_observer:null,_nextColumn:null}},watch:{value(e){this.current=e||this.align,this.updateIcon()}},mounted(){!this.value&&this.current&&this.$emit("input",this.current),this.$nextTick(()=>{const e=this.$el.closest(".k-column");e&&(e.style.display="none");const t=e==null?void 0:e.nextElementSibling,n=t==null?void 0:t.querySelector(".k-field-header");if(!n)return;this.container=document.createElement("span"),this.container.className="pw-align-btn",this.container.style.cssText="position:relative;display:flex;align-items:center;",this.btnEl=document.createElement("button"),this.btnEl.type="button",this.btnEl.className="input-focus k-button",this.btnEl.setAttribute("data-has-icon","true"),this.btnEl.setAttribute("data-has-text","false"),this.btnEl.setAttribute("data-size","xs"),this.btnEl.setAttribute("data-variant","filled"),this.btnEl.setAttribute("aria-label","Align"),this.updateIcon(),this.container.appendChild(this.btnEl),this.btnEl.addEventListener("click",i=>{i.stopPropagation(),this.toggleDropdown()}),this._closeHandler=i=>{this.container.contains(i.target)||this.closeDropdown()},document.addEventListener("click",this._closeHandler);const s=n.querySelector(".k-button");s&&s.parentElement!==n?s.parentElement.prepend(this.container):s?n.insertBefore(this.container,s):n.appendChild(this.container),this._nextColumn=t,this.updateVisibility(),this._observer=new MutationObserver(()=>this.updateVisibility()),this._observer.observe(t,{childList:!0,subtree:!0})})},methods:{updateVisibility(){if(!this.container||!this._nextColumn)return;if(this.alwaysVisible){this.container.style.display="flex";return}const e=this._nextColumn.querySelector(".k-item, .k-block, .k-structure-item")!==null;this.container.style.display=e?"flex":"none"},updateIcon(){if(!this.btnEl)return;const e=this.current||"left";this.btnEl.innerHTML='<span class="k-button-icon"><svg class="k-icon"><use xlink:href="#icon-text-'+e+'"></use></svg></span>'},toggleDropdown(){this.show?this.closeDropdown():this.showDropdown()},showDropdown(){this.dropdownEl&&this.dropdownEl.remove(),this.dropdownEl=document.createElement("dialog"),this.dropdownEl.className="k-dropdown-content pw-dropdown",this.dropdownEl.setAttribute("data-theme","dark"),this.dropdownEl.setAttribute("open","");const e=document.createElement("div");e.className="k-navigate",this.alignOptions.forEach(t=>{const n=document.createElement("button");n.type="button",n.className="k-button k-dropdown-item",n.setAttribute("data-has-icon","true"),n.innerHTML='<span class="k-button-icon"><svg class="k-icon"><use xlink:href="#icon-text-'+t+'"></use></svg></span>',n.addEventListener("click",s=>{s.stopPropagation(),this.select(t)}),e.appendChild(n)}),this.dropdownEl.appendChild(e),this.container.appendChild(this.dropdownEl),this.show=!0},closeDropdown(){this.dropdownEl&&(this.dropdownEl.remove(),this.dropdownEl=null),this.show=!1},select(e){this.current=e,this.updateIcon(),this.closeDropdown(),this.$emit("input",e)}},beforeDestroy(){this._observer&&this._observer.disconnect(),this.container&&this.container.remove(),this._closeHandler&&document.removeEventListener("click",this._closeHandler)},template:'<div style="display:none"></div>'},N={props:{value:String,label:String,help:String,disabled:Boolean},data(){return{current:this.value||"",icons:[],search:"",setName:""}},watch:{value(e){this.current=e||""}},computed:{filtered(){const e=this.search.trim().toLowerCase();return e?this.icons.filter(t=>t.id.toLowerCase().includes(e)):[]},selectedIcon(){return this.current&&this.icons.find(e=>e.svg===this.current)||null},showCount(){return this.search.trim()?this.filtered.length:this.icons.length}},async created(){try{const e=await this.$api.get("pagewizard/config"),t=e["icon-set"];this.setName=e["icon-set-name"]||t;const n=await this.$api.get("pagewizard/icons/"+t);this.icons=Array.isArray(n)?n:[]}catch{this.icons=[]}},methods:{select(e){this.disabled||(this.current=e?e.svg:"",this.$emit("input",this.current))},clear(){this.disabled||(this.current="",this.$emit("input",""))},isActive(e){return this.current===e.svg}},template:`
